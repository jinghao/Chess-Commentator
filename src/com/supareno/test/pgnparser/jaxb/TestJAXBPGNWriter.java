...
public class TestJAXBPGNWriter {
	...
	public void testWriterInitExtension(){
		...
		assertEquals("xml", w.getExtension());
	}
	...
	public void testChangeFileName(){
		...
		assertEquals("test/newfilename.xml", writer.getFileName()+"."+writer.getExtension());
	}
	...
	public void testWritePGNGames(){
		assertFalse(writer.writePGNGame(null));
		String filename="target/referencegame.xml";
		writer.setFileName(filename);
		assertTrue("xml not written", writer.writePGNGame(JUnitTestConstants.REFERENCE_GAME_2_0));
		/*
		...
		Game expected = JUnitTestConstants.REFERENCE_GAME_2_0;
