...
\paragraph{Automated sportscasting.} Chen and Mooney~\shortcite{chen} 
...
Guid et al.~\shortcite{Guid} discuss the use of argument based machine 
...
et al.~\shortcite{Bengio07greedylayer-wise}, we use a greedy strategy to 
